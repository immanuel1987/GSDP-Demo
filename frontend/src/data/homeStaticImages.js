/**
 * Homepage imagery — current-generation youth in groups (graduation, campus life, mission).
 * Local Don Bosco University reference + high-resolution Wikimedia Commons (no historical grain).
 */
...
export function staticPanelThumbAt(index) {
  const meta = staticHeroSlideMetaAt(index)
  return { url: meta.url, pos: meta.bgPos, alt: meta.alt }
}
