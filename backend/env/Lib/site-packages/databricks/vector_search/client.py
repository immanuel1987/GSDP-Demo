...
class VectorSearchClient:
    ...
    def update_endpoint(
        ...
        :param int target_qps: Target queries per second for the endpoint. Must be a positive integer,
                               or -1 to reset to default. Use ``TARGET_QPS_RESET_TO_DEFAULT`` for
                               clarity. Optional.
        ...
        **Example**::
            ...
            from databricks.vector_search.client import VectorSearchClient
            from databricks.vector_search.client import TARGET_QPS_RESET_TO_DEFAULT
            ...
            response = client.update_endpoint(
                name="my-endpoint", target_qps=TARGET_QPS_RESET_TO_DEFAULT
            )
        ...
        if target_qps is not None:
            ...
            if target_qps == 0 or target_qps < -1:
                raise InvalidInputException(
                    "target_qps must be a positive integer or -1 (to reset to default)."
                )
